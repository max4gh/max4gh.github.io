...
>11. 尽可能的使用 NOT NULL
>12. Prepared Statements （这个涉及到Web安全）
>15. 固定长度的表会更快
>16. 垂直分割
>18. 越小的列会越快
>19. 选择正确的存储引擎
...
>查询缓存的开启与查看，请查看另一文件 "MySQL查询缓存.md"
...
此文来源于:[MySQL性能优化的最佳20+条经验](http://coolshell.cn/articles/1846.html)
